<template>
  <d2-container>
      ...
      <div class="header-cover">
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          <el-form-item label="排序">
            <el-select v-model="formInline.orderBy" placeholder="请选择">
              <el-option
    ...
    <el-table :data="data" border fit style="width: 100%;">
      <el-table-column label="圈子名称" align="center" prop="groupName">
      </el-table-column>

      <el-table-column label="圈子banner图" align="center">
        <template slot-scope="scope">
          <img
            :src="picturePrefix + scope.row.groupBanner"
            alt="暂无图片"
      ...
      <el-table-column label="粉丝数" align="center" prop="fansCount">
      </el-table-column>

      <el-table-column label="内容数" align="center" prop="contentCount">
      </el-table-column>
        ...
        <template slot-scope="scope">
          ...
          >
            <el-button
              ...
              size="small"
              @click="
                switchline(scope.row.groupId, scope.row.isActive === 1 ? 0 : 1)
              "
            ></el-button>
          </el-tooltip>
...
import {
  ...
  circleNew,
  circleEdit
} from '@/api/circleManage/circleManageApi'
...
export default {
  ...
  methods: {
    ...
    edit(val) {
      this.dialogFormVisible = true
      this.form = val
      this.fileList = [{ url: this.picturePrefix + this.form.groupBanner }]
