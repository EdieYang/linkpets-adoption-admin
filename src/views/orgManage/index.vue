  ...
  <d2-container>
    <template slot="header">
      ...
      <div class="header-cover">
        ...
        <el-button type="primary"
                   size="medium"
                   @click="dialogFormVisible = true">完善组织信息</el-button>
      </div>
    ...
    <el-dialog title="公益组织信息"
      ...
      <el-form :model="form"
               ref="ruleForm"
               :rules="rules">
        <el-form-item label="公益组织名称"
                      :label-width="formLabelWidth"
                      prop="orgName">
          <el-input v-model="form.orgName"
                    autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="公益组织简介"
                      :label-width="formLabelWidth"
                      prop="orgBrief">
...
<script>
import { listOrgUsers, getOrgInfo, saveOrgInfo } from '@/api/orgManage/orgManageApi'
