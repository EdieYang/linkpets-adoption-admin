    ...
    <template slot="header">
      <div class="header-cover">
         <el-button type="primary"
                    ...
                    @click="addQuestionnaire">新建表单</el-button>
      </div>
    </template>
    <el-table :data="data"
              border
        ...
        <template slot-scope="scope">
          <el-tooltip content="设置"
            ...
            <el-button type="success"
                       ...
                       circle
                       size="small"
                       @click="edit(scope.row.questionnaireId)"></el-button>
          </el-tooltip>
          <el-tooltip content="删除"
            ...
            <el-button type="danger"
                       ...
                       circle
                       size="small"
                       @click="deleteQuestionnaire(scope.row.questionnaireId)"></el-button>
          </el-tooltip>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { questionnaireList, questionnaireDelete } from "@/api/questionnaireManage/questionnaireManageApi"
